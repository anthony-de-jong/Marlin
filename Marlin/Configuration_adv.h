 ...
 */
  ...
  #define PROBING_MARGIN_LEFT    0 //     NOZZLE_TO_PROBE_OFFSET.X
  #define PROBING_MARGIN_RIGHT   0 // -20  //   - NOZZLE_TO_PROBE_OFFSET.X
  #define PROBING_MARGIN_FRONT   0 //     NOZZLE_TO_PROBE_OFFSET.Y
  #define PROBING_MARGIN_BACK    0 // N - NOZZLE_TO_PROBE_OFFSET.Y // N is a larger number because of a more powerfull probe.
#endif
